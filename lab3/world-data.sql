...
CREATE TABLE  `country` ( `Code` char(3) PRIMARY KEY,   
			  ...
			  `Code2` char(2) NOT NULL DEFAULT '' ) DEFAULT CHARSET=utf8;
...
CREATE TABLE `countrylanguage` ( `CountryCode` CHAR(3) NOT NULL DEFAULT '', 
				`Language` CHAR(30) NOT NULL DEFAULT '', 
				`IsOfficial` enum('T','F') NOT NULL DEFAULT 'F', 
				`Percentage` FLOAT(4,1) NOT NULL DEFAULT '0.0', 
				PRIMARY KEY (`CountryCode`,`Language`), 
				KEY `CountryCode` (`CountryCode`), 
				FOREIGN KEY (`CountryCode`) REFERENCES `country`(`Code`) ) DEFAULT CHARSET = utf8;

DROP TABLE IF EXISTS `continent`;
CREATE TABLE `continent` ( `Name` enum('Asia','Europe','North America','Africa','Oceania','Antarctica','South America'),   
			   `Area` int(20),
			   `Percent total mass` float,
			   `Most populous city` varchar(30),
			   PRIMARY KEY (`Name`)) DEFAULT CHARSET = utf8;

INSERT INTO `continent` VALUES ('Africa','30370000','20.4','Cairo, Egypt');
INSERT INTO `continent` VALUES ('Antarctica','14000000','9.2','McMurdo Station, USA');
...
--ej 5
--ALTER TABLE country
--ADD CONSTRAINT FOREIGN KEY (Continent) REFERENCES continent (Name);

--ej 6
--UPDATE countrylanguage SET Percentage=100 WHERE CountryCode='AIA';

--ej7
--SELECT name FROM city WHERE District='Cordoba' AND CountryCode='ARG';
...
--ej10
-- SELECT Name,Population FROM country WHERE Population>35000000 AND Population<45000000 ORDER BY Population;

--ejercicio 1
--select Name, Region FROM country ORDER BY Name
--2) nombre y poblacion de las 10 mas pobladas
--SELECT Name AS n,Population AS p FROM country ORDER BY p DESC LIMIT 10;
--3)Liste el nombre, región, superficie y forma de gobierno de los 10 países con menor superficie
--SELECT Name,Region,SurfaceArea AS s,GovernmentForm FROM country ORDER BY s LIMIT 10;
...
-- Countries
--Select c.name, cl.Percentage From country c INNER JOIN countrylanguage cl ON cl.IsOfficial='T' AND cl.CountryCode=c.code
